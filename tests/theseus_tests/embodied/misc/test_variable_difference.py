...
def test_error_local_cost_fn_so2():
    ...
    sq_dist_errors = np.load("tests/theseus_tests/embodied/misc/sq_dist_errors_so2.npy")
    k = 0
...
def test_error_local_cost_fn_se2():
    ...
    sq_dist_errors = np.load("tests/theseus_tests/embodied/misc/sq_dist_errors_se2.npy")
    k = 0
